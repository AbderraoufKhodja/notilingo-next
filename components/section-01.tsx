        ...
        <div className="py-12 md:py-28 md:pb-20">
          ...
          <div className="max-w-sm mx-auto grid gap-12 md:grid-cols-3 md:-mx-9 md:gap-0 items-start md:max-w-none">
            ...
            >
              ...
              <h4 className="text-xl font-bold mb-1"> Real-Time Notifications</h4>
              <p className="text-slate-500">
              Notifications in foreign languages are automatically translated in real-time, ensuring you never miss important information.
              </p>
            </div>
            ...
            >
              ...
              <h4 className="text-xl font-bold mb-1">AI Powered</h4>
              <p className="text-slate-500">
              Advanced AI and machine learning algorithms ensure high accuracy in translations, adapting to the user's language preferences and context.
              </p>
            </div>
            ...
            >
              ...
              <h4 className="text-xl font-bold mb-1">Right on Your Status Bar</h4>
              <p className="text-slate-500">
              Seamlessly integrates with your device's status bar for a smooth user experience, allowing you to view translations without switching apps.
              </p>
            </div>
          </div>
        </div>
