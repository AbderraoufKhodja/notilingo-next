          ...
          <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left">
            ...
            <div className="md:w-[600px]">
              ...
              <p className="text-lg text-blue-200 mb-8" data-aos="fade-up" data-aos-delay="200">
                Say goodbye to the frustration of not understanding foreign language notifications and hello to a personalized, efficient, and engaging experience.
              </p>
            ...
            {/* Image */}
            <div className="max-w-sm mx-auto md:max-w-none md:absolute md:left-[600px] md:top-[-250px] -mb-12 md:-mt-12 md:mb-0">
