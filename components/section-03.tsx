                ...
                <div className="flex max-w-md mx-auto md:mx-0 text-left" data-aos="fade-up" data-aos-anchor="[data-aos-id-3]" data-aos-delay="300">
                  ...
                  <div>
                    <blockquote className="text-slate-500 m-0">
                      “ Following shopping deals and promotions, getting logistics updates, being notified about coming events, and more much more ... I am not missing anything! Thank you Notilingo! ” - Paul
                    </blockquote>
                  </div>
                </div>
              </div>
